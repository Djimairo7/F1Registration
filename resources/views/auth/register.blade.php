                            ...
                            <form action="/register" method="post" enctype="multipart/form-data" class="p-3">
                                ...
                                <div class="form-group mb-3">
                                    <label for="password-confirm"
                                        class="col-md-4 col-form-label">{{ __('Verifieer Wachtwoord') }}</label>


                                    <input id="password-confirm" type="password" class="form-control bg-secondary"
                                        name="password_confirmation" placeholder="Verifieer je Wachtwoord" required
                                        autocomplete="new-password">
                                </div>
                        </div>
                        <button type="submit"
